...
{
    public partial class KermaColisão : Form
    {
        public KermaColisão()
        {
            InitializeComponent();
        ...
        private void KermaColisao_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'proRadDataSet.ConstanteKermaColisão' table. You can move, or remove it, as needed.
            this.constanteKermaColisãoTableAdapter.Fill(this.proRadDataSet.ConstanteKermaColisão);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strConn))
            {
                ...
                using (SqlCommand com = new SqlCommand("SELECT [" + energia + "] FROM ConstanteKermaColisão WHERE Material = '" + material + "'", conn))
                {
