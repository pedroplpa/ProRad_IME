...
{
    public partial class Taxa_de_Fluência : Form
    {
        public Taxa_de_Fluência()
        {
            //Inicializa
            InitializeComponent();
            ...
            toolTip1.SetToolTip(textBox_x, "Preencha com a fluência da radiação em m^-2");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            result.Text = (fluencia / tempo).ToString() + " m^-2 s^-1";
        }
